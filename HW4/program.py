...
for i in range(1,len(all_frames)):
    ...
    #print(datetime.datetime.strptime(all_frames[0]['Date'][i], '%Y-%m-%d').weekday())
...
for j in Symbols:
    for i in range(len(all_frames[0]['Date'])):
        ...
        #print(all_frames[0]['Date'][i], datetime.datetime.strptime(all_frames[0]['Date'][i], '%Y-%m-%d').weekday())
